 ...
 *
 * File: Adapter/Calendar/Google/GoogleApiClient.php
 * Purpose: Defines the GoogleApiClient component used by the Calendar Scheduler Adapter/Calendar/Google layer.
 */
